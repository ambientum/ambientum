...
# Modified to allow no interaction install mode
# Original Copyrigh and Source script: https://github.com/glenpike/npm-g_nosudo
...
# read nothing since its running inside docker RUN
...
export MANPATH="$NPM_PACKAGES/share/man:/usr/share/man"
'
...
printf "\n\n"
# dont read the env fix, just do it
