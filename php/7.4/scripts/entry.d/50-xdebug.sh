...
if [[ $XDEBUG_ENABLED == true ]]; then
    ...
    echo "xdebug.remote_host=host.docker.internal" | sudo tee -a /etc/php7/conf.d/00_xdebug.ini > /dev/null
    ...
    echo 'xdebug.idekey = "'${XDEBUG_IDE_KEY:-ambientum}'"' | sudo tee -a /etc/php7/conf.d/00_xdebug.ini > /dev/null
fi